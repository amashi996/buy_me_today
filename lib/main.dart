...
import 'package:buy_me_today/data/data.dart';
...
import 'package:buy_me_today/resources/colors.dart';
import 'package:buy_me_today/views/home.dart';
...
class StarRating extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: <Widget>[
        Image.asset(
          rating >= 1 ? "assets/star.jpg" : "assets/stargrey.png",
          width: 13,
          height: 13,
        ),
        SizedBox(
        ...
        Image.asset(
          rating >= 2 ? "assets/star.jpg" : "assets/stargrey.png",
          width: 13,
          height: 13,
        ),
        SizedBox(
        ...
        Image.asset(
          rating >= 3 ? "assets/star.jpg" : "assets/stargrey.png",
          width: 13,
          height: 13,
        ),
        SizedBox(
        ...
        Image.asset(
          rating >= 4 ? "assets/star.jpg" : "assets/stargrey.png",
          width: 13,
          height: 13,
        ),
        SizedBox(
        ...
        Image.asset(
          rating >= 5 ? "assets/star.jpg" : "assets/stargrey.png",
          width: 13,
          height: 13,
        ),
      ],
